...
<p>
Joined Client-1 to the domain on DC-1 by changing Client-1 DNS settings in Azure and point it to the Domain Controller on DC-1; also made Client-1 accessible by Remote Desktop so other non-admin users can login on the computer.
